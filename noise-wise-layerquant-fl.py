...
def parse_args():
    ...
    parser.add_argument("--data-root", type=str, default="/Users/chentonghao/IWQoS/newdiff/data/")
    ...
    parser.add_argument("--log-prefix", type=str, default="fedavg_resnet18_layerwise_quant")
    parser.add_argument(
        "--enable-gdc",
        dest="enable_gdc",
        action="store_true",
...
def main():
    ...
    train_set, test_set = load_datasets(args.data_root)
...
# python3 /Users/chentonghao/WASA/ob1.py \
#   --data-root /Users/chentonghao/IWQoS/newdiff/data/ \
#   --num-clients 10 \
#   --clients-per-round 5 \
